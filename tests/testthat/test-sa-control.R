...
test_that('control_sim_anneal arg passing', {
  ...
  expect_equal(control_sim_anneal(radius = .12)$radius, .12)
...
test_that('control_sim_anneal bad arg passing', {
  ...
  expect_equal(control_sim_anneal(radius = 0)$radius, 0.001)
  expect_equal(control_sim_anneal(radius = 2)$radius, 0.999)
  expect_error(
